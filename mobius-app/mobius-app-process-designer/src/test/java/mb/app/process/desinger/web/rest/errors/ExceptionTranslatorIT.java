package mb.app.process.desinger.web.rest.errors;

import mb.app.process.desinger.MobiusAppProcessDesignerApp;
...
@SpringBootTest(classes = MobiusAppProcessDesignerApp.class)
