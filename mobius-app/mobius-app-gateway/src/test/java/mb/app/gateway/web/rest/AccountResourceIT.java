package mb.app.gateway.web.rest;

import mb.app.gateway.MobiusAppGatewayApp;
import mb.app.gateway.config.Constants;
import mb.app.gateway.domain.User;
import mb.app.gateway.repository.AuthorityRepository;
import mb.app.gateway.repository.UserRepository;
import mb.app.gateway.security.AuthoritiesConstants;
import mb.app.gateway.service.UserService;
import mb.app.gateway.service.dto.PasswordChangeDTO;
import mb.app.gateway.service.dto.UserDTO;
import mb.app.gateway.web.rest.vm.KeyAndPasswordVM;
import mb.app.gateway.web.rest.vm.ManagedUserVM;
...
import static mb.app.gateway.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = MobiusAppGatewayApp.class)
