package mb.app.gateway.repository;

import mb.app.gateway.MobiusAppGatewayApp;

import mb.app.gateway.config.Constants;
import mb.app.gateway.config.audit.AuditEventConverter;
import mb.app.gateway.domain.PersistentAuditEvent;
...
import static mb.app.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
