...
angular.module('app').controller('FlowableProcessReferenceCtrl',
...
angular.module('app').controller('FlowableProcessReferencePopupCtrl', [ '$scope', '$http', function($scope, $http) {
