...
angular.module('app').controller('FlowableCaseReferenceCtrl',
...
angular.module('app').controller('FlowableCaseReferencePopupCtrl', [ '$scope', '$http', 'editorManager', function($scope, $http, editorManager) {
