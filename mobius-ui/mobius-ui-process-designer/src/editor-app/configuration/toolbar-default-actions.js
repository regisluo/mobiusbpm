...
angular.module('app').controller('SaveModelCtrl', [ '$rootScope', '$scope', '$http', '$route', '$location', 'editorManager',
...
angular.module('app').controller('ValidateModelCtrl',['$scope', '$http', 'editorManager',
