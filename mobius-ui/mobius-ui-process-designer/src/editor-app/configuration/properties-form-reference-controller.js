...
angular.module('app').controller('FlowableFormReferenceDisplayCtrl',
...
angular.module('app').controller('FlowableFormReferenceCtrl',
    [ '$scope', '$modal', '$http', function($scope, $modal, $http) {
...
angular.module('app').controller('FlowableFormReferencePopupCtrl',
