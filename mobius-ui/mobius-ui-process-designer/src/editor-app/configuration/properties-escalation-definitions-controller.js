...
angular.module('app').controller('FlowableEscalationDefinitionsCtrl', ['$scope', '$modal', function ($scope, $modal) {
...
angular.module('app').controller('FlowableEscalationDefinitionsPopupCtrl',
