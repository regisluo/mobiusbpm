...
angular.module('app').controller('FlowableMessageDefinitionsCtrl', ['$scope', '$modal', function ($scope, $modal) {
...
angular.module('app').controller('FlowableMessageDefinitionsPopupCtrl',
