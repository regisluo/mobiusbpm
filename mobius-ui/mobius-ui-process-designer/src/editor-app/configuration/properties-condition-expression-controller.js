...
angular.module('app').controller('FlowableConditionExpressionCtrl', [ '$scope', '$modal', function($scope, $modal) {
...
angular.module('app').controller('FlowableConditionExpressionPopupCtrl',
