...
angular.module('app').controller('FlowableStringPropertyCtrl', [ '$scope', function ($scope) {
...
angular.module('app').controller('FlowableBooleanPropertyCtrl', ['$scope', function ($scope) {
...
angular.module('app').controller('FlowableTextPropertyCtrl', [ '$scope', '$modal', '$timeout', function($scope, $modal, $timeout) {
...
angular.module('app').controller('FlowableTextPropertyPopupCtrl', ['$scope', function($scope) {
