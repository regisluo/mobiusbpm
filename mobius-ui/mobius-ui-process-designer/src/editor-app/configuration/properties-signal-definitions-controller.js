...
angular.module('app').controller('FlowableSignalDefinitionsCtrl', ['$scope', '$modal', function ($scope, $modal) {
...
angular.module('app').controller('FlowableSignalDefinitionsPopupCtrl',
